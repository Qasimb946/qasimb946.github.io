...
<p align="center">
  <img src="/css/pinn-feature.png" alt="Image1" width="500" height="300">
</p>

### Physics Problem Solved with PINNs and DNN
Deep Neural Networks are primarily data-driven models. They learn to approximate complex functions directly from data without explicit knowledge of the underlying physics or equations governing the system. They are versatile and can learn patterns and relationships from large datasets.


<p align="center">
  <img src="/css/nn.gif" alt="Image" width="500" height="300">
  <center><figcaption style="font-style: italic;">Phyiscs Problem with DNN (Mosley 2021) </figcaption></center>
</p>
